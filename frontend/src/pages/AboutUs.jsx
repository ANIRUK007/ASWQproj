    ...
    <div className="min-h-screen py-20 bg-gray-50">
      <div className="container mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <p className="text-gray-600">Meet Our Expert</p>
        </div>
              ...
              <div className="grid md:grid-cols-3 gap-12 items-start">
                <div className="md:col-span-2">
                  <h2 className="text-4xl font-bold text-gray-800 mb-2">
                    Jahanji <span className="text-gray-600 text-2xl">(joe bandra)</span>
                  </h2>
                  ...
                  <div className="mt-12">
                    <h3 className="text-3xl font-bold text-gray-800 mb-6">BOOKS</h3>
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                      {[1, 2, 3, 4].map((book) => (
                        <div
                          key={book}
                          className="bg-gray-200 h-48 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300"
                        >
